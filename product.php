...
<body>
	...
	<div class="super_container">
				...
				?>
					<div class='col-lg-6'>
						<div class='details_image'>
							<div class='details_image_large'><img src='images/<?php echo $row['foto'] ?>' alt=''>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-6">
						<div class="details_content">
							...
							<div class="product_quantity_container">
								<div class="button cart_button"><a href="process/update-cart.php?id=<?php echo $id; ?>">Add to cart</a></div>
							</div>
							<?php } ?>
						</div>
					</div>
				...
				<div class="row">
					<div class="col">
						...
						<div class="product_grid">
							<?php
								$query = 
								"SELECT id, nama, harga_jual, , foto, stok from produk";
		...
		<footer class="footer">
			<div class="footer_background" style="background-image:url(images/banner4.jpg)"></div>
			<div class="container">
				<div class="row">
					<div class="col">
