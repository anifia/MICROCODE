                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div id="submenu-5" class="collapse submenu" style="">
                                            <ul class="nav flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" href="pages/tables/suplier/table_suplier.php">Data
                                                        Suplier</a>
                                                </li>
                                                <!-- <li class="nav-item">
                        ...
                        <div class="container-fluid dashboard-content ">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p><b>Toko Fashion MICROCODE</b> merupakan aplikasi Toko Fashion berbasis
                                            web. Di aplikasi ini, terdapat pembagian user/multi user yaitu
                                            Admin dan customer. Selain itu aplikasi ini terdiri
                                            dari menu produk, pesanan, kategori, suplier, pembelian, user.
                                            Diharapkan aplikasi ini dapat memudahkan pekerjaan dalam
                                            melakukan pendataan produk,pesanan,pembelian, dan suplier.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    Copyright © 2022 Concept. All rights reserved. Dashboard by MICROCODE <a href="https://colorlib.com/wp/">Colorlib</a>.
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
