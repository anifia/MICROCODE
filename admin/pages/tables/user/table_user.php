                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = 
                                            "SELECT * FROM users where username !='admin' AND deleted=0 ORDER BY id";
                                            ...
                                            if (mysqli_num_rows($result) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_assoc($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>******</td>
                                                        <td>
                                                            <a href='form_edit_user.php?id=$id' class='btn btn-warning'>Update</a>
                                                            <a href='process/delete_user.php?id=$id' class='btn btn-danger'>Delete</a>
                                                        </td>
                                                    </tr>
                                                    ";
                                                }
