                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = "SELECT * FROM jenis_produk where deleted=0";
                                            ...
                                            if (mysqli_num_rows($result) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_assoc($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>" . $row["nama"]  . "</td>
                                                        <td>
                                                            <a href='form_edit_kategori.php?id=$id' class='btn btn-warning'>Update</a>
                                                            <a href='process/delete_kategori.php?id=$id' class='btn btn-danger'>Delete</a>
                                                        </td>
                                                    </tr>
                                                    ";
                                                }
