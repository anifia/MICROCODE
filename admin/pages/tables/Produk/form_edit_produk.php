                        ...
                        <div class="row">
                            <div class="col-xl-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <img src="../../../../images/<?php echo $item['foto'] ?>" width="335px">
                                        <br><br>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <select name="jenis_id" class="form-control" required>
                                                    ...
                                                    <?php 
                                                $tampilkan_isi = "select * from jenis_produk";
                                                ...
                                                while ($isi = mysqli_fetch_array($tampilkan_isi_sql))
                                                {
                                                    ...
                                                    echo "<option value='".$isi['id']."'".$tag.">".$isi['nama']."</option>";
                                                }
                                                ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" name="harga_beli" class="form-control" placeholder="Harga Beli"
                                                    value="<?php echo $item['harga_beli'] ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" name="harga_jual" class="form-control" placeholder="Harga Jual"
                                                    value="<?php echo $item['harga_jual'] ?>" required>
                                            </div>
                                        </div>
