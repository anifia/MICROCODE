                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="../pengarang/table_pengarang.php">Data Pesanan</a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="process/add_produk.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <?php 
                                    $tampilkan_isi = "select count(id) as jumlah from produk;";
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="id" class="form-control" value="BU-<?php echo $no+$jumlah ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select required name="id" class="form-control" required>
                                                <option value="" disabled selected>--</option>
                                                <?php 
                                                $tampilkan_isi = "select * from jenis_produk where deleted = 0";
                                                $tampilkan_isi_sql = mysqli_query($con,$tampilkan_isi);
                                                $no = 1;
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="file" name="deskripsi" class="form-control" required>
                                        </div>
                                    </div>
