                            ...
                            <div class="card-body">
                                ...
                                <table id="tabell" class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = 
                                            "SELECT * FROM produk WHERE deleted = 0";
                                            ...
                                            if (mysqli_num_rows($result) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_assoc($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>" . $row["stok"] . "</td>
                                                        <td><img src='../../../../images/". $row["foto"] ."' width='200px'></td>
                                                        <td>
                                                            <a href='form_edit_produk.php?id=$id' class='btn btn-warning'>Update</a>
                                                            <a href='process/delete_produk.php?id=$id' class='btn btn-danger'>Delete</a>
                                                        </td>
                                                    </tr>
                                                    ";
                                                }
