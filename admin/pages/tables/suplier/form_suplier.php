    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../../../dashboard.php">MICROCODE</a>
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="../suplier/table_suplier.php">Data Suplier</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="../transaksi/table_transaksi.php">Data Pembelian</a>
                                        </li>
                                        <li class="nav-item">
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Suplier</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Tables</a></li>
                                            <li class="breadcrumb-item"><a href="table_suplier.php" class="breadcrumb-link">Data
                                                    Suplier</a></li>
                                            <li class="breadcrumb-item active" aria-current="page"></li>Form Suplier
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="process/add_suplier.php" method="POST">

                                    <?php 
                                    $tampilkan_isi = "select count(id) as jumlah from suplier;";
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">ID Suplier</label>
                                        <div class="col-md-9">
                                            <input type="text" name="id" class="form-control" value="PN-<?php echo $no+$jumlah ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Nama Suplier</label>
                                        <div class="col-md-9">
                                            <input type="text" name="nama" class="form-control" placeholder="Nama Suplier"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="kota" class="form-control" placeholder="Kota Suplier" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="alamat" id="" cols="30" rows="10" class="form-control"
                                                placeholder="Alamat Suplier" required></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" name="telpon" class="form-control" placeholder="Nomor Telepon" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-5">
                                        <div class="col-md-6">
                                            <!-- back to home -->
                                            <a name="backBtn" id="backBtn" class="btn btn-dark btn-block btn-lg" href="table_suplier.php"
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            Copyright © 2022 MICROCODE . All rights reserved.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        </div>
                    </div>
