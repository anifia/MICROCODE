                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="process/edit_suplier.php" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="kota" class="form-control" placeholder="Kota Suplier"
                                                value="<?php echo $item['kota'] ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="alamat" id="" cols="30" rows="10" class="form-control"
                                                placeholder="Alamat Suplier" required><?php echo $item['alamat'] ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="kontak" class="form-control" placeholder="Kontak"
                                                value="<?php echo $item['kontak'] ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" name="telpon" class="form-control" placeholder="Nomor Telepon"
                                                value="<?php echo $item['telpon'] ?>" required>
                                        </div>
                                    </div>
