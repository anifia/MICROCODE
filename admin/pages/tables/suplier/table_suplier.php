                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = 
                                            "SELECT * FROM suplier WHERE deleted = 0";
                                            ...
                                            if (mysqli_num_rows($result) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_assoc($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>" . $row["telpon"] . "</td>
                                                        <td>
                                                            <a href='form_edit_suplier.php?id=$id' class='btn btn-warning'>Update</a>
                                                            <a href='process/delete_suplier.php?id=$id' class='btn btn-danger'>Delete</a>
                                                        </td>
                                                    </tr>
                                                    ";
                                                }
