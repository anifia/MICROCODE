        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <?php 
                        $tampilkan_isi = "select count(id) as jumlah from users;";
                        ...
                        ?>
                                ...
                                <input type="hidden" name="id" value="CUS-<?php echo $no+$jumlah; ?>">
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="number" name="telpon">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
