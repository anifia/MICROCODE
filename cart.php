	...
	<div class="super_container">
			...
			<div class="menu_container menu_mm">
				<div class="page_menu_content">
					...
					<div class="page_menu_search menu_mm">
						<form action="#">
							<input type="search" required="required" class="page_menu_search_input menu_mm" placeholder="Search Products...">
						</form>
					</div>
				...
				<tbody>
					<?php
						if(isset($_SESSION["keranjang"]))
						{
							...
							$ambil = $con->query("SELECT * FROM pembelian WHERE id='$id'");
					...
					<tr>
						...
						<td width='50px'>
							<div class="button"><a href="process/delete-cart.php?id=<?php echo $id; ?>">Hapus</a></div>
						</td>
					</tr>
					<?php
					$nomor++;
		...
		<div class="col-lg-8 offset-lg-2">
			<div class="cart_total">
				...
				<div class="section_subtitle">Sebelum melakukan proses checkout silahkan konfirmasi ke nomor 0857xxxxx (Whatsapp)</div>
				...
				<br>
				<div class="button checkout_button"><a href="process/input-cart.php">Proses</a></div>
			</div>
		</div>
		<?php } ?>
